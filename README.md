...
As JEST standards, `\___tests___` folders are created to place Javascript test files. '.test.js' string is appended after the Javascript file name for convention. Building this project with maven will exclude all `__tests__` folders.
